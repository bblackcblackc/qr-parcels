...
if (!isset($oPOSTData->data->lat) or !isset($oPOSTData->data->lon) or !isset($oPOSTData->data->parcelID))
		{
...
$fLat = floatval($oPOSTData->data->lat);
$fLon = floatval($oPOSTData->data->lon);
$sPlace = (isset($oPOSTData->data->placeName) ? $oPOSTData->data->placeName : "");

// assign
$iParcelEvent = $oParcel->AddParcelEvent($mysqli, $cCourier->courierID, OPERATION_PARCEL_INFO, $cCourier->courierID,
